      ...
      <Modal
        ...
        title={
          <div>
            ...
            <p>⚠️ Создайте резервную копию своего кошелька, <b>скопировав и сохранив его приватный ключ</b>🔑 в безопасном месте. Если вы потеряете его, вы будете заблокированы из вашего кошелька! <b>Никогда и никому не сообщайте</b> свой секретный ключ!!!⚠️</p>
          </div>
        }
        onOk={() => { 
          setOpen(!open);
